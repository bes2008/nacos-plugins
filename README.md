...
|:---------------------:|:------------------:|:------------------------:|---------------------------------|:-------------------------------:|
|        `1.0.x`        |       `io.github.bes2008.solution.nacosplugins`       |       `2.4.1`       |   理论上`>=2.2.0，<=2.4.3`   | `2.3.2`<br/>`2.4.1`<br/>`2.4.2` |
|  `2.0.0` ~ `2.0.14`   |       `io.github.bes2008.solution.nacosplugins`       |       `2.4.2`       |  理论上`>=2.2.0, <=2.4.3`   | `2.3.2`<br/>`2.4.1`<br/>`2.4.2` |
| `2.5.1.0` ~ `2.5.1.1` | `io.github.qhsword.nacosplugins` | `2.5.1` | 理论上：`>=2.2.0, <= 2.5.1` <br/>3.0.x | `2.4.2` <br/>`2.4.3`<br/> `2.5.1` |
